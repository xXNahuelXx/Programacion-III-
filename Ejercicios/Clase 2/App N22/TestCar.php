...
echo "<br><br>SEGUNDA PARTE<br><br>";
$garage = new Garage("Pepito's Garage", 3000);

//Agrego 3 autos al garage
$garage->Add($carOne);
$garage->Add($carTwo);
$garage->Add($carThree);
//Muestro el garage con sus datos
echo $garage->ShowGarage();
//Trato de agregar un auto que ya existe
$garage->Add($carOne);
//Remuevo un auto
$garage->Remove($carTwo);
//Intento remover un auto que ya no existe
$garage->Remove($carTwo);
//Vuelvo a mostrar como quedo el garage
echo $garage->ShowGarage();
